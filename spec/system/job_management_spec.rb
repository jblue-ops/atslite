...
RSpec.describe "Job Management", :js, type: :system do
  ...
  describe "Job listing page" do
    ...
    context "when user is authenticated", :authenticated do
      before do
  ...
  describe "Creating a new job" do
    context "as a recruiter", :authenticated do
      before do
        sign_in_user(recruiter_user)
        visit new_job_path
      end
      ...
      it "creates a job successfully with valid data" do
        ...
        expect(current_path).to match(%r{/jobs/\d+})
      end
  ...
  describe "Editing a job" do
    ...
    context "as authorized user", :authenticated do
      before do
  ...
  describe "Job details page" do
    ...
    context "when viewing job details", :authenticated do
      before do
        sign_in_user(recruiter_user)
        visit job_path(job)
      end
  ...
  describe "Job search and filtering" do
    ...
    context "when searching and filtering", :authenticated do
      before do
        sign_in_user(recruiter_user)
        visit jobs_path
      end
  ...
  describe "Bulk operations" do
    ...
    context "as admin user", :admin do
      before do
  ...
  describe "Real-time updates" do
    ...
    context "when viewing job details", :authenticated, :js do
      before do
        sign_in_user(recruiter_user)
        visit job_path(job)
      end
  ...
  describe "Mobile responsiveness" do
    ...
    context "on mobile device", :authenticated do
      before do
