FactoryBot.define do
  factory :candidate do
    ...
    availability { ['immediate', '2_weeks', '1_month', '2_months'].sample }
    willing_to_relocate { [true, false].sample }
    work_authorization { ['us_citizen', 'permanent_resident', 'h1b', 'opt', 'student_visa'].sample }
    ...
    trait :with_diversity_info do
      gender { ['male', 'female', 'non_binary', 'prefer_not_to_say'].sample }
      ethnicity { ['asian', 'black', 'hispanic', 'white', 'other', 'prefer_not_to_say'].sample }
  ...
  factory :reference do
    ...
    phone { Faker::PhoneNumber.phone_number }
    relationship { ['manager', 'colleague', 'client', 'mentor'].sample }
