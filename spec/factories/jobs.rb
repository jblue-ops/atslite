FactoryBot.define do
  factory :job do
    ...
    employment_type { ['full_time', 'part_time', 'contract', 'internship'].sample }
    experience_level { ['entry', 'mid', 'senior', 'lead', 'executive'].sample }
    ...
    trait :with_skills do
      after(:create) do |job|
        skills = ['Ruby', 'Rails', 'JavaScript', 'React', 'PostgreSQL', 'AWS']
    ...
    trait :posted_to_job_boards do
      job_board_postings { ['indeed', 'linkedin', 'glassdoor'] }
