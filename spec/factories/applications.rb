FactoryBot.define do
  factory :application do
    ...
    trait :final_interview do
      current_stage { 'final' }
      after(:create) do |application|
        ['screening', 'technical'].each_with_index do |stage, index|
          create(:stage_transition, application: application,
    ...
    trait :rejected do
      ...
      rejection_reason { ['not_qualified', 'cultural_fit', 'compensation', 'other'].sample }
      after(:create) do |application|
  ...
  factory :rejection do
    ...
    reason { ['not_qualified', 'cultural_fit', 'compensation_mismatch', 'position_filled', 'other'].sample }
